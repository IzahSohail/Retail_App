        ...
        <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-red-700 mb-2">
              Your business verification application has been rejected by our admin team.
            </p>
            {businessInfo?.b2b?.rejectionReason && (
              <div className="mt-2 p-3 bg-red-100 rounded">
                <p className="text-sm font-medium text-red-900">Reason:</p>
                <p className="text-sm text-red-800">{businessInfo.b2b.rejectionReason}</p>
              </div>
            )}
            <p className="text-sm text-red-700 mt-3">
              You can resubmit your application with corrected information below.
            </p>
          </div>
        </div>
      )}
